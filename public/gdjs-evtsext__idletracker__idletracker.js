...
gdjs.evtsExt__IdleTracker__IdleTracker.IdleTracker = class IdleTracker extends gdjs.RuntimeBehavior {
  ...
  applyBehaviorOverriding(behaviorOverriding) {
    ...
    if (behaviorOverriding.LastX !== undefined)
      this._behaviorData.LastX = behaviorOverriding.LastX;
    if (behaviorOverriding.LastY !== undefined)
      this._behaviorData.LastY = behaviorOverriding.LastY;
    if (behaviorOverriding.IsFarFromLastPosition !== undefined)
      this._behaviorData.IsFarFromLastPosition = behaviorOverriding.IsFarFromLastPosition;
    if (behaviorOverriding.DurationBeforeIdle !== undefined)
      this._behaviorData.DurationBeforeIdle = behaviorOverriding.DurationBeforeIdle;
    if (behaviorOverriding.IdleDistanceTolerance !== undefined)
      this._behaviorData.IdleDistanceTolerance = behaviorOverriding.IdleDistanceTolerance;
    if (behaviorOverriding.IdleTime !== undefined)
      this._behaviorData.IdleTime = behaviorOverriding.IdleTime;
